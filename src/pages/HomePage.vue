                            ...
                            <div class="col-12 col-md-6 mt-3 ">
                                <div class="content-area">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <vue-editor v-model="data.home_content_en"></vue-editor>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 mt-3 ">
                                <div class="content-area">
                                    ...
                                    <div class="form-group">
                                        <label for="title"><strong>Slider Text*</strong></label>
                                        <vue-editor v-model="data.home_content_ar"></vue-editor>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mt-3 ">
                                <div class="content-area">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  v-model="data.insti_title_en" class="form-control mb-3" placeholder="Enter Title">
                                    </div>
                                    <div class="form-group">
                                        <label for="title"><strong>Tagline*</strong></label>
                                        <input type="text"  v-model="data.insti_tagline_en" class="form-control mb-3" placeholder="Tagline">
                                    </div>
                                    <div class="form-group">
                                        <label for="title"><strong>Description*</strong></label>
                                        <vue-editor  v-model="data.insti_content_en"></vue-editor>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 mt-3 ">
                                <div class="content-area">
                                    ...
                                    <div class="form-group">
                                        <label for="title"><strong>Enter Title*</strong></label>
                                        <input type="text" v-model="data.insti_title_ar"  class="form-control mb-3" placeholder="Enter Title">
                                    </div>
                                    <div class="form-group">
                                        <label for="title"><strong>Tagline*</strong></label>
                                        <input type="text"  v-model="data.insti_tagline_ar" class="form-control mb-3" placeholder="Tagline">
                                    </div>
                                    <div class="form-group">
                                        <label for="title"><strong>Description*</strong></label>
                                        <vue-editor v-model="data.insti_content_ar"></vue-editor>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        saveHomeDetails(){
            ...
            axios
            .post(this.APIServer + "front/home-slider/save", this.data)
            .then((response) => {
